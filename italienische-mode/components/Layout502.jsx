    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 md:w-auto lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Stücke</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Alle italienischen kollektionen
          </h1>
          <p className="md:text-md">
            Durchsuchen Sie unsere Auswahl nach Damen, Herren oder allen
            Stücken. Jedes Teil ist ausgewählt, nichts ist zufällig.
          </p>
        ...
        <Tabs defaultValue="tab-one">
          ...
          >
            <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:items-center md:gap-x-12 lg:gap-x-20">
              ...
              <div>
                <p className="mb-3 font-semibold md:mb-4">Neu</p>
                <h2 className="rb-5 mb-5 text-4xl font-bold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                  Elegante schnitte für frauen
                </h2>
                <p>
                  Italienische mode, die den körper versteht. Klassisch,
                  zeitlos, immer passend.
                </p>
