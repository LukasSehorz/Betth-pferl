          ...
          <div className="flex flex-col gap-y-16 md:sticky md:top-20 md:mt-20 md:h-[calc(100vh_-10rem)] md:justify-center">
            <div className="flex flex-col">
              ...
              <p className="md:text-md">
                Durchsuchen Sie unsere Auswahl nach Marke, Größe und Stil. Jedes
                Stück erzählt eine Geschichte italienischer Handwerkskunst.
              </p>
              <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                <Button title="Damen" variant="secondary">
                  Damen
                </Button>
                <Button
                  title="Herren"
              ...
              <AnimatePresence>
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      <h5 className="mb-3 text-xl font-bold">Nach Marke</h5>
                      <p>
                        Finden Sie Ihre perfekte Passform in jeder Kollektion.
                      </p>
                      <div className="mt-4">
                        <img
                          src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-1.svg"
                ...
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      <h5 className="mb-3 text-xl font-bold">Nach Größe</h5>
                      <p>
                        Finden Sie Ihre perfekte Passform in jeder Kollektion.
                      </p>
                      <div className="mt-4">
                ...
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      <h5 className="mb-3 text-xl font-bold">Nach Farbe</h5>
                      <p>
                        Klassisch, modern oder zeitlos elegant — wählen Sie
                        Ihren Weg.
                      </p>
                      <div className="mt-4">
                        <img
                ...
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      <h5 className="mb-3 text-xl font-bold">Nach Stil</h5>
                      <p>
                        Finden Sie Ihre perfekte Passform in jeder Kollektion.
                      </p>
                      <div className="mt-4">
