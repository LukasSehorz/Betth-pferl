          ...
          <div className="mx-auto mb-12 max-w-lg md:mb-18 lg:mb-20">
            <div>
              ...
              <h2 className="mb-5 text-center text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                Entdecken Sie italienische Mode nach Kategorie
              </h2>
              <p className="text-center md:text-md">
                Wählen Sie zwischen Damen und Herren oder durchsuchen Sie alle
                Stücke nach Ihrem Geschmack.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 items-start gap-y-12 md:grid-cols-2 md:gap-x-8 md:gap-y-16 lg:grid-cols-4">
            <div className="w-full">
              ...
              <p className="text-center">
                Elegante italienische Schnitte und Stoffe speziell für Frauen.
              </p>
            </div>
            <div className="w-full">
              <div className="mb-5 flex justify-center md:mb-6">
              ...
              <p className="text-center">
                Klassische und moderne italienische Mode für Männer.
              </p>
            </div>
            <div className="w-full">
              <div className="mb-5 flex justify-center md:mb-6">
              ...
              <p className="text-center">
                Zeitlose Schnitte, die nie aus der Mode kommen.
              </p>
            </div>
            <div className="w-full">
              <div className="mb-5 flex justify-center md:mb-6">
              ...
              <p className="text-center">
                Die neuesten italienischen Kollektionen in unserer Boutique.
              </p>
            </div>
          </div>
