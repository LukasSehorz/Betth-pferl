      ...
      <div className="container">
        <div className="mx-auto max-w-lg text-center">
          ...
          <p className="md:text-md">
            Erhalten Sie Einladungen zu Privatberatungen, neue Kollektionen und
            Geschichten aus unserer Boutique.
          </p>
          <div className="mx-auto mt-6 w-full max-w-sm md:mt-8">
            ...
            <p className="text-xs">
              Mit der Anmeldung akzeptieren Sie unsere Datenschutzerklärung und
              Nutzungsbedingungen.
            </p>
          </div>
        </div>
