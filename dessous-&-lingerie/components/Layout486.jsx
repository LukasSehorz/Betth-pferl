      ...
      <div className="container">
        <div className="relative grid auto-cols-fr grid-cols-1 items-start gap-x-8 gap-y-12 md:grid-cols-[0.75fr_1fr] md:gap-y-16 lg:grid-cols-[max-content_1fr] lg:gap-x-20">
          ...
          <div className="grid auto-cols-fr grid-cols-1 gap-x-12 gap-y-12 md:gap-x-28 md:gap-y-28">
            ...
            >
              <h2 className="hidden">BHs</h2>
              <div className="hidden" />
              <p className="mb-3 font-semibold md:mb-4">
                Klassische formen, perfekte passform
              </p>
              <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                Von der alltäglichen Unterstützung bis zur festlichen Eleganz.
                Jeder BH ist ein Meisterwerk italienischer Schneiderei,
                entworfen für den weiblichen Körper in all seinen Variationen.
              </h2>
              <p className="md:text-md">Entdecken</p>
