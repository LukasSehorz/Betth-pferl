          ...
          <div className="grid grid-cols-1 gap-12 md:block">
            <div>
              <div className="flex flex-col items-start justify-center md:h-screen">
                <p className="mb-3 font-semibold md:mb-4">Anfahrt</p>
                <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                  Von München aus — etwa eine Stunde
                </h2>
                <p className="md:text-md">
                  Autobahn A8 Richtung Salzburg. Ausfahrt Prien. Dann dem See
                  entgegen.
                </p>
                <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                  <Button title="Route" variant="secondary">
                    Route
                  </Button>
                  <Button
                    title="Maps"
