      ...
      <div className="container">
        <div className="rb-12 mb-12 grid auto-cols-fr grid-cols-1 items-start gap-x-5 gap-y-5 md:mb-18 md:grid-cols-2 md:gap-x-12 lg:mb-20 lg:gap-x-20 lg:gap-y-20">
          <div className="flex h-full flex-col">
            ...
            <h1 className="text-5xl font-bold md:text-7xl lg:text-8xl">
              Entdecken Sie die besten Stücke dieser Saison
            </h1>
          </div>
          <div className="mx-[7.5%] flex flex-col justify-end md:mt-40">
            <p className="md:text-md">
              Wählen Sie zwischen unseren Damen- und Herrenkollektion oder sehen
              Sie alle reduzierten Stücke auf einen Blick.
            </p>
            <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
              ...
              <Button
                title="Exklusive Auswahl aus unserer Damenkollektion mit handverlesenen Stücken für diese Saison."
                variant="link"
                size="link"
                iconRight={<RxChevronRight />}
              >
                Exklusive Auswahl aus unserer Damenkollektion mit handverlesenen
                Stücken für diese Saison.
              </Button>
            </div>
          </div>
        </div>
        <div className="grid auto-cols-fr grid-cols-1 items-start gap-12 md:grid-cols-3 md:gap-8 lg:gap-12">
          <div className="w-full">
            ...
            <p>
              Sorgfältig kuratierte Highlights aus unserer Herrenkollektion —
