        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <div className="rb-4 mb-4 flex w-full items-center justify-start">
              ...
              <p className="inline text-sm font-semibold">7 Minuten Lesezeit</p>
            </div>
            ...
            <p>Ein Blick auf die Herkunft und Verarbeitung feiner Stoffe</p>
            <Button
              title="Beitrag lesen"
              variant="link"
              size="link"
          ...
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <p>Wie persönliche Beratung den Unterschied macht</p>
            <Button
              title="Beitrag lesen"
              variant="link"
              size="link"
          ...
          <div className="flex size-full flex-col items-start justify-start text-start">
            ...
            <div className="rb-4 mb-4 flex w-full items-center justify-start">
              ...
              <p className="inline text-sm font-semibold">6 Minuten Lesezeit</p>
            </div>
            <a className="mb-2 flex justify-start text-start" href="#">
              <h2 className="text-xl font-bold md:text-2xl">
            ...
            <p>Entdecken Sie die Meister hinter unseren Kollektionen</p>
            <Button
              title="Beitrag lesen"
              variant="link"
              size="link"
